...
namespace App\Http\Controllers\Admin\KonsultasiBimbinganAkademik;
...
class KonsultasiBimbinganAkademikController extends Controller
{
    ...
    {
        $konsultasi = BimbinganAkademik::with('konsultasi_bimbingan_akademik', 'dosen')->findOrFail($request->bimbingan_id);
        return view('admin.konsultasi_bimbingan_akademik.index', compact('konsultasi'));
    }
