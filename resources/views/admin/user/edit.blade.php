    ...
    <div class="card mb-4" style="border-radius: 10px">
        ...
        <div class="card-body p-0">
            <div class="px-5 py-4">
                ...
                @endif
                <form method="POST" action="{{ route('user.update_user', $data->id) }}">
                    @csrf
                    <div class="form-group mb-1">
                        <label class="col-form-label text-dark" for="nama" style="font-weight: 500">Nama</label>
                        <input id="nama" type="text" class="form-control @error('nama') is-invalid @enderror"
                            placeholder="Masukan Nama Lengkap" name="nama" value="{{$data->nama}}" required
                    ...
                    <div class="form-group mb-1">
                        ...
                        <input id="email" type="text" class="form-control @error('email') is-invalid @enderror"
                            placeholder="Masukan Email" name="email" value="{{ $data->email }}" required
                    ...
                    <div class="form-group mb-1">
                        ...
                        <input id="password" type="password" class="form-control @error('password') is-invalid @enderror"
                            placeholder="Buat Password" name="password" autocomplete="new-password">
                    ...
                    <div class="form-group mb-1">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="role" id="mahasiswa_role" value="user"
                                checked />
                    ...
                    <div class="form-group mb-1">
                        ...
                        <input id="noreg" type="text" class="form-control @error('noreg') is-invalid @enderror"
                            placeholder="Masukan NIM" name="noreg" value="{{ $data->noreg }}" required
                            autocomplete="noreg" autofocus>
                        @error('noreg')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div id="mahasiswa">
                            ...
                            <select class="form-control" name="nama_dosen_pa" id="nama_dosen_pa" required>
                                ...
                                @foreach ($user as $item)
                                    <option value="{{ $item->nama }}"
                                        {{ $data->nama_dosen_pa == $item->nama ? 'selected' : '' }}>
                                        {{ $item->nama }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group mb-3">
                            ...
                            <input id="angkatan" type="text"
                                ...
                                placeholder="Tahun masuk kuliah" name="angkatan" value="{{ $data->angkatan }}" required
    ...
    <script>
        $(document).ready(function() {
            ...
            if (role === 'dosen') {
                ...
                $('#mahasiswa_role').prop('checked',true);
                $('#mahasiswa').show();
                $('#dosen').hide();
