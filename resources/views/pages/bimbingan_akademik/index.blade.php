...
@section('content')
    ...
    <div class="card mb-4" style="border-radius: 10px">
        ...
        <div
            ...
            <h6 class="m-0 font-weight-bold text-muted"><i class="fas fa-chalkboard-teacher mr-1"></i> Bimbingan Akademik
            </h6>
        </div>
        <!-- Card Body -->
        <div class="card-body">
            <div class="text-right mb-3">
                <a href="{{ route('bimbingan-akademik.create') }}" class="btn btn-success btn-sm"><i
                        class="fas fa-plus"></i>
                    Tambah</a>
            </div>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    @if ($item->status == 'ditolak')
                                        {{ $item->keterangan }}
                                    @else
                                        <a href="{{ route('konsultasi-bimbingan-akademik.index', ['bimbingan_id' => $item->id]) }}"
