    ...
    <div class="col-12 col-lg-8">
        <div class="card">
            <div class="selected-user">
                <span>To: <span class="name">{{ $konsultasi->dosen->nama }}</span></span>
            </div>
            <div id="chat-container" class="chat-container vh-100 overflow-auto" style="background-size: contain;background-image:url({{ url('img/bg-chat.jpg') }})">
                <ul class="chat-box">
                    @php
                    $tgl_chat = [];
                    @endphp
            ...
            <form action="{{ route('konsultasi-bimbingan-akademik.store') }}" method="POST">
                @csrf
...
<script>
    $(document).ready(function() {
        $('#chat-container').animate({
            scrollTop: $('#chat-container')[0].scrollHeight}, 1000);
        function getUrl() {
            $.ajax({
